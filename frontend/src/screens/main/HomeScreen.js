      ...
      >
        ...
        <View style={styles.greetingContainer}>
          <Text style={styles.greetingTitle}>
            Xin chào, {user?.fullName || DEFAULT_USER.fullName}
          </Text>
        ...
        <View style={styles.statsRow}>
          <MetricCard
            label="TỔNG ĐIỂM"
            value={String(user?.totalScore || 1280)}
          />
          <MetricCard
            label="ĐIỂM TRUNG BÌNH"
            value={String(
              user?.totalQuizzes > 0
                ? Math.round((user.totalScore || 0) / user.totalQuizzes)
                : 85,
            )}
          />
          <MetricCard
            ...
            value={
              user?.totalQuestions > 0
                ? `${Math.round(((user.correctQuestions || 0) / user.totalQuestions) * 100)}%`
                : "83%"
            }
          />
        </View>
